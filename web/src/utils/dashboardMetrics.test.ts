...
describe('getDashboardMetrics', () => {
  it('summarizes application progress and status distribution', () => {
    ...
    expect(metrics.statusMetrics).toEqual([
      { status: 'Not Started', label: 'Not Started', value: 2, percentage: 25 },
      { status: 'In Progress', label: 'In Progress', value: 4, percentage: 50 },
      { status: 'Submitted', label: 'Submitted', value: 1, percentage: 13 },
      { status: 'Awarded', label: 'Awarded', value: 0, percentage: 0 },
      { status: 'Not Awarded', label: 'Closed', value: 1, percentage: 13 },
    ]);
