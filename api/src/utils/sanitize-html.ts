import createDOMPurify, { type Config } from 'isomorphic-dompurify';

/**
 * Server-side HTML Sanitization Utility
 *
 * Uses DOMPurify with JSDOM to sanitize HTML on the server.
...
// Create a DOMPurify instance (isomorphic-dompurify handles JSDOM automatically)
const DOMPurify = createDOMPurify;

/**
 * HTML Sanitization Configuration Profiles
 */
export const SanitizationProfiles: Record<string, Config> = {
  /**
